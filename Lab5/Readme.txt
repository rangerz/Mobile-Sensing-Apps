...
C.  System Design
	...
	This App provides a GUI for controlling or displaying information
	...
	0x0C		0x0000			Interrupt by Analog Input - Turn on all LED
			0x0001			Interrupt by Analog Input - Turn off all LED